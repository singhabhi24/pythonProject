...
func main() {
	...
	sequence_val := Sequence{"NON_TIME_BASED", "000000000ac0", map[string]int32{}, 5, 0}
...
func PMNConverter(ktab string, sequence_num Sequence, encOpcKey string, encTopcKey string, algorithmId string, supi string) *protos.PMNSubscriberData {
